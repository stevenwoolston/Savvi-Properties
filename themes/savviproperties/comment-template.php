...
function comment_form_custom( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => 'SBW<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea class="form-control" id="comment" name="comment" cols="45" rows="2" aria-describedby="form-allowed-tags" aria-required="true" required="required"></textarea></p>',
