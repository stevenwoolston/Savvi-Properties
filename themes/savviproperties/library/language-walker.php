<?php
	 ...
	 *
	 */
	class Language_Walker extends Walker_Nav_Menu
	{
		...
		function start_el(&$output, $item, $depth, $args)
		{
			...
			if ($item->hasChildren && $depth == 0) {
				$item_output .= '<a'. $attributes .' role="button" aria-haspopups="true" aria-expanded="false" class="dropdown-toggle" data-toggle="dropdown">';
			} else {
